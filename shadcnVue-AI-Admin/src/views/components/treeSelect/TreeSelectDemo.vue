...
<template>
  <div class="p-6 space-y-8">
    ...
    <div class="border rounded-lg overflow-hidden shadow-sm">
      <div class="px-4 py-3 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 border-b">
    ...
    <!-- 复选框单选演示 -->
    <div class="border rounded-lg overflow-hidden shadow-sm">
      <div class="px-4 py-3 bg-gradient-to-r from-cyan-50 to-teal-50 dark:from-cyan-950/30 dark:to-teal-950/30 border-b">
    ...
    <!-- 多选演示 -->
    <div class="border rounded-lg overflow-hidden shadow-sm">
      <div class="px-4 py-3 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 border-b">
      ...
      <div class="p-4 bg-white dark:bg-gray-950 space-y-4">
        <div class="flex items-center gap-2">
          <span class="text-sm text-muted-foreground w-16">选中值：</span>
          <code class="text-sm bg-muted px-2 py-0.5 rounded">{{ multiValue.length ? multiValue.join(', ') : '(空)' }}</code>
        </div>
        <TreeSelect
          v-model="multiValue"
          :data="treeData"
    ...
    <!-- 搜索功能演示 -->
    <div class="border rounded-lg overflow-hidden shadow-sm">
      <div class="px-4 py-3 bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-950/30 dark:to-violet-950/30 border-b">
      ...
      <div class="p-4 bg-white dark:bg-gray-950 space-y-4">
        ...
        />
        <div v-if="searchEvents.length" class="p-3 rounded bg-green-50 dark:bg-green-950/20 border border-green-200 text-sm space-y-1 max-h-32 overflow-y-auto">
    ...
    <!-- 懒加载演示 -->
    <div class="border rounded-lg overflow-hidden shadow-sm">
      <div class="px-4 py-3 bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30 border-b">
    ...
    <!-- 事件日志 -->
    <div class="border rounded-lg overflow-hidden shadow-sm">
      <div class="px-4 py-3 bg-gradient-to-r from-gray-50 to-slate-50 dark:from-gray-950/30 dark:to-slate-950/30 border-b">
      ...
      <div class="p-4 bg-white dark:bg-gray-950">
        <div class="p-3 rounded bg-gray-50 dark:bg-gray-900 border font-mono text-sm space-y-1 max-h-48 overflow-y-auto">
